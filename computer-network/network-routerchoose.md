...
![image-20220505234103177](https://gitee.com/cxuan-personal/picgo/raw/master/img/image-20220505234103177.png)
...
![image-20220505234112083](https://gitee.com/cxuan-personal/picgo/raw/master/img/image-20220505234112083.png)
...
RIP 的全称是 *Routing Information Protocol*，路由信息协议。它是 IGP 中最先得到广泛应用的一种协议，就像很多刚诞生的萌芽一样，它最大的特征就是简单。
...
由此我们可以归纳出 RIP 协议的两个特点：第一个特点就是它只会和相邻的路由器交换消息，那么这个"相邻"该如何判断呢？如果两个路由器之间的通信不需要再经过另一个路由器，就说这两个路由器是相邻的。RIP 还规定不相邻的路由器不会交换信息。第二个特点就是说每个路由器会毫不保留的交换自己知道的全部信息，也就是把路由表进行交换。

>还有一个非常重要的问题我们忽略了，既然我们知道 RIP 协议规定了交换信息的规则，那它是如何规定交换的时间间隔呢？
...
![image-20220508211526979](https://gitee.com/cxuan-personal/picgo/raw/master/img/image-20220508211526979.png)
