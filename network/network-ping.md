###### 每日一句英语学习，每天进步一点点：
![](https://imgkr.cn-bj.ufileos.com/58af5bbd-d714-4b93-81ef-d3e0b949b401.png)
...
![来自面试官的灵魂拷问](https://imgkr.cn-bj.ufileos.com/923bdc1e-0c3d-49ab-a6e8-1fd9c5015951.jpg)

不知道的小伙伴也没关系，今天我们就来搞定它，搞懂它。消除本次的问号，**让问号少一点**。

![](https://imgkr.cn-bj.ufileos.com/3a5b0e48-0d60-4b19-8e25-c10f3e76d46b.gif)
...
![ICMP 报文](https://imgkr.cn-bj.ufileos.com/ee6a0dd7-e29f-4191-a8a4-5e91952826af.png)
...
![ICMP 回送消息](https://imgkr.cn-bj.ufileos.com/f3c147de-f002-465a-ab0a-b8c6abc340be.png)

可以向对端主机发送**回送请求**的消息（`ICMP Echo Request Message`，类型 `8`），也可以接收对端主机发回来的**回送应答**消息（`ICMP Echo Reply Message`，类型 `0`）。

![ICMP 回送请求和回送应答报文](https://imgkr.cn-bj.ufileos.com/59e9af51-f75b-4a2c-b4af-55799cdb054e.png)
...
![目标不可达类型的常见代码号](https://imgkr.cn-bj.ufileos.com/f491cdf1-71fd-4c88-a2f0-f9fa898abf8e.png)
...
![外卖员 —— 小林](https://imgkr.cn-bj.ufileos.com/06fe236b-b52d-48a6-aa41-d69fbb108dd2.png)
...
![ICMP 时间超过消息](https://imgkr.cn-bj.ufileos.com/d4713314-e4d3-4670-ac99-7aad549a46d4.png)
...
![主机 A ping 主机 B](https://imgkr.cn-bj.ufileos.com/0bf7e9ed-afeb-4409-aeee-67f614770270.png)
...
![主机 A 的 ICMP 回送请求报文](https://imgkr.cn-bj.ufileos.com/001d5db6-10d4-483a-9034-73055a08c685.png)
...
![主机 A 的 IP 层数据包](https://imgkr.cn-bj.ufileos.com/0980af0a-6792-4559-b076-327f1f39be8a.png)

接下来，需要加入 `MAC` 头。如果在本地 ARP 映射表中查找出 IP 地址 192.168.1.2 所对应的 MAC 地址，则可以直接使用；如果没有，则需要发送 `ARP` 协议查询 MAC 地址，获得 MAC 地址后，由数据链路层构建一个数据帧，目的地址是 IP 层传过来的 MAC 地址，源地址则是本机的 MAC 地址；还要附加上一些控制信息，依据以太网的介质访问规则，将它们传送出去。

![主机 A 的 MAC 层数据包](https://imgkr.cn-bj.ufileos.com/f5ebffca-4f88-48c3-9e7d-67e0a9ce7f03.png)
...
![主机 B 的 ICMP 回送响应报文](https://imgkr.cn-bj.ufileos.com/d4f3d9e5-3b1d-4426-ac96-1d3b732f55b4.png)
...
![主机 A ping 主机 B 期间发送的事情](https://imgkr.cn-bj.ufileos.com/1a67bf04-4209-4b34-a58b-88d51ec4efd8.png)
...
![MTU 路径发现（UDP的情况下）](https://imgkr.cn-bj.ufileos.com/6fc435cb-ad91-4300-90e5-8d141310e622.png)
