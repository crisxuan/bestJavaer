...
![IP 基础知识全家桶](https://imgkr.cn-bj.ufileos.com/46f68658-caa7-4558-ab62-c8e7480355b1.png)
...
![IP 的作用](https://imgkr.cn-bj.ufileos.com/003abdf0-c04c-4240-bd68-3b16126599f3.png)
...
![IP 的作用与 MAC 的作用](https://imgkr.cn-bj.ufileos.com/258556d2-509a-4ffb-a444-0d4fdf55141f.png)
...
![点分十进制](https://imgkr.cn-bj.ufileos.com/fdeffeff-eeea-456f-bd23-3a1637e556a0.png)

那么，IP 地址最大值也就是

![](https://imgkr.cn-bj.ufileos.com/7929d424-2191-4919-a7e6-34054479e1c8.png)

也就说，最大允许 43 亿台计算机连接到网络。

实际上，IP 地址并不是根据主机台数来配置的，而是以网卡。像服务器、路由器等设备都是有 2 个以上的网卡，也就是它们会有 2 个以上的 IP 地址。

![每块网卡可以分配一个以上的IP地址](https://imgkr.cn-bj.ufileos.com/5aaa9a5d-72a0-4fc9-a859-fe95f0643f65.png)
...
![IP 地址分类](https://imgkr.cn-bj.ufileos.com/d9d2eed2-4ddb-46eb-bdc2-c4ff5d4001ad.png)
...
![](https://imgkr.cn-bj.ufileos.com/eaaef0fd-ef36-46f8-a4e6-fd5f583189a2.png)

> A、B、C 分类地址最大主机个数是如何计算的呢？

最大主机个数，就是要看主机号的位数，如 C 类地址的主机号占 8 位，那么 C 类地址的最大主机个数：

![](https://imgkr.cn-bj.ufileos.com/316fd843-5f98-41c4-8daa-86cd4d5c4a5d.png)

为什么要减 2 呢？

因为在 IP 地址中，有两个 IP 是特殊的，分别是主机号全为 1 和 全为 0 地址。

![](https://imgkr.cn-bj.ufileos.com/757f1bea-d6d8-41e7-9566-8991dd54ecc7.png)
...
![本地广播与直接广播](https://imgkr.cn-bj.ufileos.com/165029f2-4e23-4ea8-8519-c6ff6cd6a070.png)
...
![](https://imgkr.cn-bj.ufileos.com/c95c2640-ec3e-468d-a919-bbc0965b1b7f.png)
...
![单播、广播、多播通信](https://imgkr.cn-bj.ufileos.com/28347f8e-91e3-456a-9a61-356c7513d8eb.png)
...
![IP 分类判断](https://imgkr.cn-bj.ufileos.com/47bcbb8a-1ad5-4e9e-91e7-3a56d3d3cb3a.png)
...
![](https://imgkr.cn-bj.ufileos.com/24199510-c23d-41ae-9dec-cad505c2835f.png)

还有另一种划分网络号与主机号形式，那就是**子网掩码**，掩码的意思就是掩盖掉主机号，剩余的就是网络号。

**将子网掩码和 IP 地址按位计算 AND，就可得到网络号。**

![](https://imgkr.cn-bj.ufileos.com/8c1753d1-c374-4985-be1e-26b6698ac378.png)
...
![IP地址的网络号](https://imgkr.cn-bj.ufileos.com/6a839760-ba48-406c-908b-b5f037343cb5.png)
...
![](https://imgkr.cn-bj.ufileos.com/783ec591-ac91-4daa-9f3c-980e234fa6ed.png)
...
![](https://imgkr.cn-bj.ufileos.com/c7133abc-5688-409b-bd88-e1879745696c.png)

由于子网网络地址被划分成 2 位，那么子网地址就有 4 个，分别是 00、01、10、11，具体划分如下图：

![](https://imgkr.cn-bj.ufileos.com/616f4b39-d30a-4cad-a48c-3c896faa5de9.png)

划分后的 4 个子网如下表格：

![](https://imgkr.cn-bj.ufileos.com/3891fad5-4311-4cfb-8660-e70224882b20.png)

#### 公有 IP 地址与私有 IP 地址

在 A、B、C 分类地址，实际上有分公有 IP 地址和 私有 IP 地址。

![](https://imgkr.cn-bj.ufileos.com/08bd19db-9ddf-4444-ab59-39b98ff33f7f.png)
...
![公有 IP 地址与私有 IP 地址](https://imgkr.cn-bj.ufileos.com/3d7673eb-8517-4377-a909-457d248d4948.png)
...
![](https://imgkr.cn-bj.ufileos.com/943c0859-fb22-4513-b53b-b8e5d63a9175.png)
...
![IP 地址与路由控制](https://imgkr.cn-bj.ufileos.com/358f5c73-3ee3-494c-b1e0-457da90596c9.png)
...
![分片与重组](https://imgkr.cn-bj.ufileos.com/48b29cc6-8688-4ed2-a75e-b8be9915f9af.png)
...
![IPv6 地址表示方法](https://imgkr.cn-bj.ufileos.com/c7c864ff-3b07-4fa3-9bf3-fad884bfa473.png)


如果出现连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开。但是，一个 IP 地址中只允许出现一次两个连续的冒号。

![Pv6 地址缺省表示方](https://imgkr.cn-bj.ufileos.com/6e4a8ad5-85e9-4414-b870-f058df504008.png)
...
![IPv6地址结构](https://imgkr.cn-bj.ufileos.com/a29e8425-3f02-419d-80ea-7b5681f7accd.png)
...
![ IPv6 中的单播通信](https://imgkr.cn-bj.ufileos.com/35a94ad4-fdbc-4c8d-99b4-cc0518260ef8.png)
...
![IPv4 首部与 IPv6 首部的差异](https://imgkr.cn-bj.ufileos.com/5363d514-5c7d-43fa-8e78-b138e7846168.png)
...
![DNS 树状结构](https://imgkr.cn-bj.ufileos.com/5e5dddb7-fe43-4525-b4d2-9fcf79695cff.png)
...
![域名解析的工作流程](https://imgkr.cn-bj.ufileos.com/2830d71d-bda7-443b-bc69-5402ff470e84.png)
...
![ARP 广播](https://imgkr.cn-bj.ufileos.com/1a6c1c16-9bdb-4c16-8129-51e6bd8e1149.png)
...
ARP 协议是已知 IP 地址 求 MAC 地址，那 RARP 协议正好相反，它是**已知 MAC 地址求 IP 地址**。例如将打印机服务器等小型嵌入式设备接入到网络时就经常会用得到。
...
![RARP](https://imgkr.cn-bj.ufileos.com/213d92e1-d428-4ee6-80e0-35e83e27b97b.png)
...
![DHCP 工作流程](https://imgkr.cn-bj.ufileos.com/37dbf6ad-cbb7-4e60-abba-e52f08c39aaf.png)
...
![ DHCP 中继代理](https://imgkr.cn-bj.ufileos.com/6ac27985-485d-4983-af31-0f1d3bb3726d.png)
...
![NAT](https://imgkr.cn-bj.ufileos.com/02f41914-6322-4240-90d4-86f8721466a3.png)
...
![NAPT](https://imgkr.cn-bj.ufileos.com/852a3b1d-7e8e-47b3-8685-2b75a6ca73a5.png)
...
也就是说，在 NAT 穿越技术中，NAT设备后的应用程序处于主动地位，它已经明确地知道 NAT 设备要修改它外发的数据包，于是它主动配合 NAT 设备的操作，主动地建立好映射，这样就不像以前由 NAT 设备来建立映射了。

说人话，就是客户端主动从 NAT 设备获取公有 IP 地址，然后自己建立端口映射条目，然后用这个
条目对外通信，就不需要 NAT 设备来进行转换了。
...
![ICMP 目标不可达消息](https://imgkr.cn-bj.ufileos.com/c0e4d384-b75c-4f63-945d-6c6ac99e1db4.png)
...
![常见的 ICMP 类型](https://imgkr.cn-bj.ufileos.com/2b3fe546-4529-45c1-acef-a9a2ba5f1831.png)
...
![组播模型](https://imgkr.cn-bj.ufileos.com/08c7518e-a3b6-4fc3-a92f-686fcf3cca5f.png)
...
![ IGMP 常规查询与响应工作机制](https://imgkr.cn-bj.ufileos.com/42c4871b-62fa-4bf6-a827-428a93a34f80.png)
...
![ IGMPv2 离开组播组工作机制 情况1](https://imgkr.cn-bj.ufileos.com/44590348-46f1-4f01-95fd-b583dbd7c686.png)
...
![ IGMPv2 离开组播组工作机制 情况2](https://imgkr.cn-bj.ufileos.com/ab7ab076-2252-4e32-a6ed-d0b2c6c1d7f9.png)
...
![](https://imgkr.cn-bj.ufileos.com/cc18a648-0ae3-42ff-8b93-eb08132a68b7.gif)


- 如果这合你口味，给小林点个「**在看**」，那小林我就心满意足啦。
- 如果口味过重，欢迎「**留言**」进行点评！
